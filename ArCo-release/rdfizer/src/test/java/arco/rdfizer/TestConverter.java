...
//					PreprocessedData.getInstance().getContenitoreGiuridicoSystemRecordCode2CCG().get("ICCD13432299"));
	...
	public void testRelatedWork() {
		...
		try {
			...
			model.getGraph().find(null, NodeFactory.createURI(ns + "count"), null).forEachRemaining(t->{
				System.out.println(t);
			});
			
			model.getGraph().find(null, NodeFactory.createURI(ns + "testRelatedWork"), null).forEachRemaining(t->{
				System.out.println(t);
			});
