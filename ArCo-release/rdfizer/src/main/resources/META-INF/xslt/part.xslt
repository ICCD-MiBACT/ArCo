...
<xsl:stylesheet version="2.0"
	...
	xmlns:dcterms="http://purl.org/dc/terms/" xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:language="https://w3id.org/italia/onto/Language/"
									...
									<xsl:attribute name="rdf:resource">
										<xsl:choose>
											<xsl:when test="../DTZ/DTZS">
												<xsl:choose>
													<xsl:when test="contains(normalize-space(lower-case(../DTZ/DTZS)), '?') or contains(normalize-space(lower-case(../DTZ/DTZS)), 'ca')">
														<xsl:value-of select="concat($NS, 'TimeInterval/', arco-fn:urify(normalize-space(./DTZ/DTZG)), '-uncertain')" />
													</xsl:when>
													<xsl:when test="contains(normalize-space(lower-case(../DTZ/DTZG)), '?') or contains(lower-case(../DTZ/DTZG), ' ca')">
														<xsl:value-of select="concat($NS, 'TimeInterval/', arco-fn:urify(normalize-space(../DTZ/DTZG)), '-', arco-fn:urify(normalize-space(../DTZ/DTZS)), '-uncertain')" />
													</xsl:when>
													<xsl:otherwise>
				...
				<xsl:if test="not(lower-case(normalize-space(./RSTP))='intero bene') and not(lower-case(normalize-space(./RSTP))='integrale') and not(lower-case(normalize-space(./RSTP))='tutta') and not(lower-case(normalize-space(./RSTP))='totale') and (not(starts-with(lower-case(normalize-space(./RSTP)), 'nr')) and not(starts-with(lower-case(normalize-space(./RSTP)), 'n.r')) and not(starts-with(lower-case(normalize-space(./RSTP)), 'intero')) and not(starts-with(lower-case(normalize-space(./RSTP)), 'intera')) and not(starts-with(lower-case(normalize-space(./RSTP)), 'esemplar')))">
					<xsl:for-each select="./RSTP">
						<rdf:Description>
							...
							<arco-cd:hasIntervention>
								<xsl:choose>
									<xsl:when test="contains(normalize-space(lower-case(../RSTI)), 'consolidamento') or contains(normalize-space(lower-case(../RSTI)), 'restaur') or contains(normalize-space(lower-case(../RSTI)), 'conservativ') or contains(normalize-space(lower-case(../RSTI)), 'controllo microclimatico') or contains(normalize-space(lower-case(../RSTI)), 'trattamento biocida-disinfestazione') or contains(normalize-space(lower-case(../RSTI)), 'rimozione di elementi non originali') or contains(normalize-space(lower-case(../RSTI)), 'pulitura meccanica') or contains(normalize-space(lower-case(../RSTI)), 'pulitura chimica') or contains(normalize-space(lower-case(../RSTI)), 'protezione finale') or contains(normalize-space(lower-case(../RSTI)), 'riadesione parti') or contains(normalize-space(lower-case(../RSTI)), 'trattamento parti metalliche')">
										<xsl:attribute name="rdf:resource">
				...
				<xsl:if test="not(lower-case(normalize-space(./REN/RENR))='intero bene') and not(lower-case(normalize-space(./REN/RENR))='carattere generale') and not(lower-case(normalize-space(./REN/RENR))='integrale') and not(lower-case(normalize-space(./REN/RENR))='tutta') and not(lower-case(normalize-space(./REN/RENR))='totale') and (not(starts-with(lower-case(normalize-space(./REN/RENR)), 'nr')) and not(starts-with(lower-case(normalize-space(./REN/RENR)), 'n.r')) and not(starts-with(lower-case(normalize-space(./REN/RENR)), 'esemplar')) and not(starts-with(lower-case(normalize-space(./REN/RENR)), 'intero')) and not(starts-with(lower-case(normalize-space(./REN/RENR)), 'intera')))">
					...
					<xsl:for-each select="./REN/RENR">
						<rdf:Description>
							...
							<xsl:if test="not(/record/metadata/schede/A/RE/REN/RENS)">
								<arco-lite:hasRealizationDate>
									<xsl:attribute name="rdf:resource">
										<xsl:choose>
