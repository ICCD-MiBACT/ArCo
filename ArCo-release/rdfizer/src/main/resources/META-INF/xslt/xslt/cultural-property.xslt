		...
		<rdf:RDF>
			...
			<xsl:if test="not($sheetType='CF' or $sheetType='CG' or $sheetType='AUT' or $sheetType='BIB') and not(administrativeDataRecord/metadata) and not(root)">
				...
				<xsl:variable name="pvcc">
					<xsl:choose>
						<xsl:when test="record/metadata/schede/*/LC/PVC/PVCC">
							<xsl:value-of select="arco-fn:urify(record/metadata/schede/*/LC/PVC/PVCC)"/>
						</xsl:when>
						<xsl:when test="record/metadata/schede/*/LC/LCC">
							<xsl:value-of select="arco-fn:urify(record/metadata/schede/*/LC/LCC)"/>
						</xsl:when>
					</xsl:choose>
				</xsl:variable>
				<!-- variable ogtp -->
				...
				<xsl:if test="not($sheetType='EVE')">
					<rdf:Description>
						...
						<xsl:if test="record/metadata/schede/*/OG/OGT/OGTP and not($sheetType='AT' or $sheetVersion='4.00_ICCD0' or $sheetVersion='4.00')">
							<arco-dd:positionOnCulturalProperty>
								<xsl:value-of select="normalize-space(string-join(record/metadata/schede/*/OG/OGT/OGTP,' ; '))" />
								<!-- RA 3.00 unbounded eg:ICCD10088602 -->
							</arco-dd:positionOnCulturalProperty>
						</xsl:if>
						...
						<xsl:if test="record/metadata/schede/MIDF/LR">
							<arco-location:hasTimeIndexedTypedLocation>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'TimeIndexedTypedLocation/', $itemURI, '-shot')" />
								</xsl:attribute>
						...
						<xsl:if test="record/metadata/schede/MODI/LC/* or record/metadata/schede/SCAN/LC/* or record/metadata/schede/AR/LC/*">
							<arco-lite:hasCulturalPropertyAddress>
								<xsl:attribute name="rdf:resource">
									<xsl:choose>
										<xsl:when test="record/metadata/schede/*/LC/LCS and not(lower-case(normalize-space(record/metadata/schede/*/LC/LCS))='italia')">
										...
										<xsl:otherwise>
											<xsl:choose>
												<xsl:when test="record/metadata/schede/AR/LC">
						...
						<xsl:if test="record/metadata/schede/AR/OG/OGU">
							<arco-arco:numberOfComponents>
								<xsl:value-of select="normalize-space(record/metadata/schede/AR/OG/OGU)" />
							</arco-arco:numberOfComponents>
						</xsl:if>
						...
						<xsl:if test="record/metadata/schede/MIDF/OG/OGF">
							<arco-cd:stripRunAndFrameNumber>
								<xsl:value-of select="normalize-space(record/metadata/schede/MIDF/OG/OGF)" />
							</arco-cd:stripRunAndFrameNumber>
						</xsl:if>
						...
						<xsl:if test="record/metadata/schede/*/MT/QNT/QNTC">
							<arco-arco:numberOfContainers>
								<xsl:value-of select="normalize-space(record/metadata/schede/*/MT/QNT/QNTC)" />
							</arco-arco:numberOfContainers>
						</xsl:if>
						<xsl:if test="record/metadata/schede/*/MT/QNT/QNTN">
							<arco-arco:numberOfElements>
								<xsl:value-of select="normalize-space(record/metadata/schede/*/MT/QNT/QNTN)" />
							</arco-arco:numberOfElements>
						</xsl:if>
						...
						<xsl:if test="record/metadata/schede/*/MT/SCA">
							<arco-cd:hasScale>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'Scale/', arco-fn:urify(normalize-space(record/metadata/schede/*/MT/SCA)))" />
								</xsl:attribute>
							</arco-cd:hasScale>
						</xsl:if>
						...
						<xsl:for-each select="record/metadata/schede/FF/OG/OGT/OGTO">
							<arco-dd:hasSortingCriterion>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS,'SortingCriterion/', arco-fn:urify(normalize-space(.)))" />
								</xsl:attribute>
							</arco-dd:hasSortingCriterion>
						</xsl:for-each>
						<!-- keywords (PST) -->
						...
						<xsl:for-each select="record/metadata/schede/*/AU/AUI">
							...
							<xsl:for-each select="record/metadata/schede/*/AU/AUI/AUIY">
								<xsl:if test="not(.) or .='intero bene' or .='integrale' or .='tutta' or .='totale' or starts-with(lower-case(normalize-space(.)), 'intero') or starts-with(lower-case(normalize-space(.)), 'intera') or starts-with(lower-case(normalize-space(.)), 'esemplar')">
									<xsl:choose>
						...
						<xsl:for-each select="record/metadata/schede/MINV/IV/INV">
							<arco-cd:hasInventorySituation>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'InventorySituation/', $itemURI, '-', position())" />
								</xsl:attribute>
						...
						<xsl:for-each select="record/metadata/schede/MIDF/IS/INV">
							<arco-cd:hasInventorySituation>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'InventorySituation/', $itemURI, '-', position())" />
								</xsl:attribute>
						...
						<xsl:if test="record/metadata/schede/MINV/IP/INP">
							<arco-cd:hasInventorySituation>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'InventorySituation/', $itemURI, '-current')" />
								</xsl:attribute>
							</arco-cd:hasInventorySituation>
							<xsl:if test="record/metadata/schede/MINV/IP/INP/INPC">
								<arco-lite:currentInventoryNumber>
									<xsl:value-of select="normalize-space(record/metadata/schede/MINV/IP/INP/INPC)" />
								</arco-lite:currentInventoryNumber>
							</xsl:if>
						</xsl:if>
						<xsl:if test="record/metadata/schede/MIDF/IS/INP">
							...
							<xsl:if test="record/metadata/schede/MIDF/IS/INP/INPC">
								<arco-lite:currentInventoryNumber>
									<xsl:value-of select="normalize-space(record/metadata/schede/MIDF/IS/INP/INPC)" />
								</arco-lite:currentInventoryNumber>
							</xsl:if>
						</xsl:if>
						...
						<xsl:if test="record/metadata/schede/MINV/IP/INP/INPA">
							<arco-cd:hasEstimate>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'Estimate/', $itemURI)" />
								</xsl:attribute>
							...
							<arco-lite:culturalPropertyValue>
								<xsl:value-of select="normalize-space(record/metadata/schede/MINV/IP/INP/INPA)" />
							</arco-lite:culturalPropertyValue>
						</xsl:if>
						<xsl:if test="record/metadata/schede/MIDF/IS/INP/INPA">
							<arco-cd:hasEstimate>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'Estimate/', $itemURI)" />
								</xsl:attribute>
							...
							<arco-lite:culturalPropertyValue>
								<xsl:value-of select="normalize-space(record/metadata/schede/MIDF/IS/INP/INPA)" />
							</arco-lite:culturalPropertyValue>
						</xsl:if>
						<xsl:for-each select="record/metadata/schede/MINV/IV/STI">
							<arco-cd:hasEstimate>
								<xsl:attribute name="rdf:resource">
						...
						<xsl:for-each select="record/metadata/schede/MIDF/IS/STI">
							<arco-cd:hasEstimate>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'Estimate/', $itemURI, '-', position())" />
								</xsl:attribute>
						...
						<!-- intervention (RS/RST for AR and PG 4.00?) DA MODIFICARE CON IL RIFERIMENTO!!!-->
						<xsl:for-each select="record/metadata/schede/*/*/RST">
							<xsl:if test="./*">
								<xsl:if test="$sheetType='AR'">
									<xsl:choose>
										<xsl:when test="./* and $sheetType='AR' and (not(./RSTP) or ./RSTP='intero bene' or ./RSTP='integrale' or ./RSTP='tutta' or ./RSTR='totale') or ./RSTP[starts-with(lower-case(normalize-space()), 'nr') or starts-with(lower-case(normalize-space()), 'n.r') or starts-with(lower-case(normalize-space()), 'intero') or starts-with(lower-case(normalize-space()), 'intera') or starts-with(lower-case(normalize-space()), 'esemplar')]">
											<arco-cd:hasIntervention>
												<xsl:attribute name="rdf:resource">
													<xsl:value-of select="concat($NS, 'ConservationIntervention/', $itemURI, '-conservation-intervention-', position())" />
												</xsl:attribute>
										...
										<xsl:otherwise>
											<arco-core:hasPart>
												<xsl:attribute name="rdf:resource">
													<xsl:value-of select="concat($NS, 'CulturalPropertyPart/', $itemURI, '-part-', arco-fn:urify(normalize-space(./RSTP)))" />
												</xsl:attribute>
											</arco-core:hasPart>
										</xsl:otherwise>
									</xsl:choose>
						...
						<xsl:if test="record/metadata/schede/MIDF/*/RST">
							<arco-cd:hasIntervention>
								<xsl:choose>
									<xsl:when test="contains(normalize-space(lower-case(./RSTI)), 'restaur') or contains(normalize-space(lower-case(./RSTI)), 'conservativi') or contains(normalize-space(lower-case(./RSTI)), 'conservative') or contains(normalize-space(lower-case(./RSTI)), 'conservativa') or contains(normalize-space(lower-case(./RSTI)), 'conservativo') or contains(normalize-space(lower-case(./RSTI)), 'consolidamento') or contains(normalize-space(lower-case(./RSTI)), 'controllo microclimatico') or contains(normalize-space(lower-case(./RSTI)), 'trattamento biocida-disinfestazione') or contains(normalize-space(lower-case(./RSTI)), 'rimozione di elementi non originali') or contains(normalize-space(lower-case(./RSTI)), 'pulitura meccanica') or contains(normalize-space(lower-case(./RSTI)), 'pulitura chimica') or contains(normalize-space(lower-case(./RSTI)), 'protezione finale') or contains(normalize-space(lower-case(./RSTI)), 'riadesione parti') or contains(normalize-space(lower-case(./RSTI)), 'trattamento parti metalliche')">
										<xsl:attribute name="rdf:resource">
							...
							<arco-location:hasTypeOfContext>
								<xsl:attribute name="rdf:resource">
									<xsl:choose>
										...
										<xsl:when test="lower-case(normalize-space(.)) = 'contesto periurbano'">
											<xsl:value-of select="'https://w3id.org/arco/ontology/location/SuburbanContext'" />
										</xsl:when>
						...
						<xsl:if test="record/metadata/schede/*/OG/CTM">
							<xsl:variable name="ctm" select="record/metadata/schede/*/OG/CTM" />
							<xsl:variable name="split" select="arco-fn:split($ctm)" />
						...
						<xsl:if test="record/metadata/schede/SI/OG/OGT/OGTA">
							<arco-cd:hasDetectionMethod>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS,'DetectionMethod/', arco-fn:urify(normalize-space(record/metadata/schede/SI/OG/OGT/OGTA)))" />
								</xsl:attribute>
							</arco-cd:hasDetectionMethod>
						</xsl:if>
						...
						<xsl:for-each select="record/metadata/schede/*/DO/FTA">
							<xsl:choose>
								<xsl:when test="contains(./FTAX, 'allegat')">
						...
						<xsl:for-each select="record/metadata/schede/*/DO/DRA">
							<xsl:choose>
								<xsl:when test="contains(./DRAX, 'allegat')">
									<arco-cd:hasAttachedDocumentation>
										<xsl:attribute name="rdf:resource">
						...
						<xsl:for-each select="record/metadata/schede/*/DO/VDC">
							<xsl:choose>
								<xsl:when test="contains(./VDCX, 'allegat')">
									<arco-cd:hasAttachedDocumentation>
										<xsl:attribute name="rdf:resource">
						...
						<xsl:for-each select="record/metadata/schede/*/DO/REG">
							<xsl:variable name="docURI" select="concat($NS, 'AudioDocumentation/', $itemURI, '-audio-documentation-', position())"/>
							<xsl:choose>
								<xsl:when test="contains(./REGX, 'allegat')">
									<arco-cd:hasAttachedDocumentation rdf:resource="{$docURI}" />
								</xsl:when>
								<xsl:otherwise>
									<arco-cd:hasDocumentation rdf:resource="{$docURI}" />
								</xsl:otherwise>
							</xsl:choose>
						</xsl:for-each>
						<!-- Sources and Documents of cultural property -->
						<xsl:for-each select="record/metadata/schede/*/DO/FNT">
						<xsl:variable name="docURI" select="concat($NS, 'SourceAndDocument/', $itemURI, '-source-document-', position())" />
						<xsl:choose>
							<xsl:when test="contains(./FNTX, 'allegat')">
							<arco-cd:hasAttachedDocumentation rdf:resource="{$docURI}" />
							</xsl:when>
							<xsl:otherwise>
							<arco-cd:hasDocumentation rdf:resource="{$docURI}" />
						...
						<xsl:for-each select="record/metadata/schede/*/DO/ADM">
							<xsl:variable name="docURI" select="concat($NS, 'MultimediaDocumentation/', $itemURI, '-multimedia-documentation-', position())" />
							<xsl:choose>
								<xsl:when test="contains(ADMX, 'allegat')">
								<arco-cd:hasAttachedDocumentation rdf:resource="{$docURI}" />
								</xsl:when>
								<xsl:otherwise>
								<arco-cd:hasDocumentation rdf:resource="{$docURI}" />
						...
						<!-- subject with iconclass code -->
						<xsl:for-each select="record/metadata/schede/*/*/DES/DESS[not(lower-case(normalize-space())='nr' or lower-case(normalize-space())='n.r.' or lower-case(normalize-space())='nr (recupero pregresso)'  or lower-case(normalize-space())='n.p'  or lower-case(normalize-space())='n.p.' or lower-case(normalize-space())='n. p')]">
							<arco-cd:hasSubject>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'Subject/', $itemURI, arco-fn:arcofy(.))" />
								</xsl:attribute>
						...
						<xsl:if test="not($sheetType='TMA')">
							<xsl:for-each select="record/metadata/schede/*/*/DES/DESI[not(lower-case(normalize-space())='nr' or lower-case(normalize-space())='n.r.' or lower-case(normalize-space())='nr (recupero pregresso)'  or lower-case(normalize-space())='n.p'  or lower-case(normalize-space())='n.p.' or lower-case(normalize-space())='n. p')]">
								<arco-lite:hasCulturalPropertySubject>
									<xsl:attribute name="rdf:resource">
						...
						<xsl:for-each select="record/metadata/schede/MIDF/OG/OGN">
							<arco-lite:title>
								<xsl:value-of select="normalize-space(.)" />
							</arco-lite:title>
							<arco-cd:hasTitle>
					...
					or 'contraffazione' or 'controtipo' or 'reimpiego' or 'copia') -->
						...
						<xsl:if test="record/metadata/schede/*/OG/CRS">
							<arco-core:hasClassificationInTime>
								<xsl:attribute name="rdf:resource">
						...
						<xsl:if test="record/metadata/schede/MIDF/DA/ISE">
							<arco-dd:hasAffixedElement>
								<xsl:attribute name="rdf:resource">
						...
						<xsl:if test="record/metadata/schede/SCAN/DA/ELR or record/metadata/schede/MINV/DA/ELR">
							<arco-dd:hasAffixedElement>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'AffixedElement/', $itemURI, position())" />
								</xsl:attribute>
						...
						<xsl:for-each select="record/metadata/schede/*/US/USA">
							<xsl:choose>
								...
								<xsl:when test="$sheetType='AR'">
									...
									<xsl:if test="./USA and (not(starts-with(lower-case(normalize-space(./USA)), 'nr')) and not(starts-with(lower-case(normalize-space(./USA)), 'n.r')))">
										<arco-lite:hasCulturalEntityUseFunction>
											<xsl:attribute name="rdf:resource">
												<xsl:value-of select="concat($NS, 'UseFunction/', arco-fn:urify(./USA))" />
											</xsl:attribute>
										</arco-lite:hasCulturalEntityUseFunction>
									</xsl:if>
								</xsl:when>
						...
						<xsl:if test="$sheetType='F' or $sheetType='MIDF'">
							<xsl:if test="record/metadata/schede/*/MT/MTX and (not(starts-with(lower-case(normalize-space(record/metadata/schede/*/MT/MTX)), 'nr')) and not(starts-with(lower-case(normalize-space(record/metadata/schede/*/MT/MTX)), 'n.r')))">
								<arco-dd:hasTechnicalStatus>
									<xsl:attribute name="rdf:resource">
										<xsl:value-of select="concat($NS, 'TechnicalStatus/', $itemURI)" />
									</xsl:attribute>
						...
						<xsl:if test="record/metadata/schede/*/TU/CDG and not($sheetType='AR')">
							<arco-cd:hasLegalSituation>
								<xsl:attribute name="rdf:resource">
						...
						<xsl:if test="record/metadata/schede/*/TU/CDG and $sheetType='AR'">
							<arco-cd:hasLegalSituation>
								<xsl:attribute name="rdf:resource">
							...
							<xsl:for-each select="record/metadata/schede/*/TU/CDS">
								<arco-lite:hasOwner>
									<xsl:attribute name="rdf:resource">
										<xsl:value-of select="concat($NS, 'Agent/', arco-fn:arcofy(.))" />
									</xsl:attribute>
						...
						<xsl:for-each select="record/metadata/schede/AR/TU/NVC">
							<arco-cd:hasProtectiveMeasure>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'ProtectiveMeasure/', $itemURI, '-protective-measure-', position())" />
								</xsl:attribute>
					...
					<rdf:Description>
						...
						<xsl:if test="not($sheetType='PG' or $sheetType='A' or $sheetType='RCG'  or $sheetType='DSC'  or $sheetType='SCAN')">
							<rdfs:comment>
								...
								<xsl:if test="record/metadata/schede/MIDF/OG/OGD">
									<xsl:value-of select="concat(record/metadata/schede/*/OG/OGD, ' ',record/metadata/schede/*/OG/OGT)"/>
								</xsl:if>
								<xsl:if test="record/metadata/schede/MINV/OG/OGD">
									<xsl:choose>
										<xsl:when test="record/metadata/schede/*/OG/OGW">
											<xsl:value-of select="concat(record/metadata/schede/*/OG/OGW, ' di ', record/metadata/schede/*/OG/OGD, ' ',record/metadata/schede/*/OG/OGT)"/>
										</xsl:when>
						...
						<xsl:if test="$sheetType='PG' or $sheetType='A'">
							<rdfs:comment>

							</rdfs:comment>
						</xsl:if>
						<!-- hasCulturalPropertyType -->
						<xsl:if test="not($sheetType='MODI' or $sheetType='SCAN' or $sheetType='MINP' or $sheetType='MINV' or $sheetType='A' or $sheetType='PG' or $sheetType='AR')">
							<xsl:for-each select="record/metadata/schede/*/OG/OGT">
								<xsl:if test="./*">
									<xsl:choose>
										<xsl:when test="not($sheetType='BNB') and not($sheetType='NU') and not($sheetType='F' and ($sheetVersion='1.00' or $sheetVersion='1.00_ICCD0')) and not($sheetType='F' and ($sheetVersion='2.00' or $sheetVersion='2.00_ICCD0'))">
						...
						<xsl:if test="$sheetType='AR'">
							<xsl:if test="record/metadata/schede/AR/OG">
								<arco-dd:hasCulturalPropertyType>
									<xsl:attribute name="rdf:resource">
										<xsl:value-of select="concat($NS, 'CulturalPropertyType/', arco-fn:arcofy(record/metadata/schede/AR/OG/OGT))" />
									</xsl:attribute>
								</arco-dd:hasCulturalPropertyType>
							</xsl:if>
						</xsl:if>
						<xsl:if test="$sheetType='SCAN' or $sheetType='MINP' or $sheetType='MINV' or $sheetType='MIDF'">
						...
						<xsl:if test="$sheetType='PG' or $sheetType='A' ">
							<xsl:for-each select="record/metadata/schede/*/OG/OGT">
								<xsl:choose>
									...
									<xsl:when test="$sheetVersion='2.00' or $sheetVersion='2.00_ICCD0'">
										<arco-dd:hasCulturalPropertyType>
											<xsl:attribute name="rdf:resource">
												<xsl:choose>
													<xsl:when test="./OGTQ">
						...
						<xsl:if test="record/metadata/schede/MIDF/RA/*">
							<arco-cd:isMemberInvolvedIn>
								<xsl:attribute name="rdf:resource">
									<xsl:value-of select="concat($NS, 'ArchivalCollectionMembership/', $itemURI)" />
								</xsl:attribute>
							...
							<arco-lite:isCollectionMemberOf>
								<xsl:choose>
									<xsl:when test="record/metadata/schede/MIDF/RA/RAT">
										<xsl:value-of select="concat($NS, 'ArchivalUnit/', $ldcm, '-', $pvcc, '-', arco-fn:urify(normalize-space(record/metadata/schede/MIDF/RA/RAT)))" />
									</xsl:when>
									<xsl:when test="record/metadata/schede/MIDF/RA/RAA">
										<xsl:value-of select="concat($NS, 'ArchivalSubseries/', $ldcm, '-', $pvcc, '-', arco-fn:urify(normalize-space(record/metadata/schede/MIDF/RA/RAA)))" />
									</xsl:when>
									<xsl:when test="record/metadata/schede/MIDF/RA/RAS">
										<xsl:value-of select="concat($NS, 'ArchivalSeries/', $ldcm, '-', $pvcc, '-', arco-fn:urify(normalize-space(record/metadata/schede/MIDF/RA/RAS)))" />
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="concat($NS, 'ArchivalFonds/', $ldcm, '-', $pvcc, '-', arco-fn:urify(normalize-space(record/metadata/schede/MIDF/RA/RAF)))" />
									</xsl:otherwise>
								</xsl:choose>
							</arco-lite:isCollectionMemberOf>
						</xsl:if>
						<!-- photographicseries membership -->
						<xsl:if test="record/metadata/schede/*/PD/SFI/*">
							<xsl:for-each select="record/metadata/schede/*/PD/SFI">
								<arco-cd:isMemberInvolvedIn>
									<xsl:attribute name="rdf:resource">
				...
				<!-- Images retrieved from the OAI-PMH service of ICCD-MiBAC > <xsl:variable name="image-link" select="arco-fn:find-image($item)" /> <xsl:if test="$image-link != ''"> <rdf:Description> <xsl:attribute name="rdf:about"> <xsl:value-of select="$objectOfDescription" /> </xsl:attribute> <foaf:image> <xsl:attribute name="rdf:resource"> <xsl:value-of select="$image-link" /> </xsl:attribute> 
