...
public class FindMaterialLinker extends SKOSThesaurusLinker implements ExtensionFunction {

	private final String THESAURUS = "META-INF/datasets/materia-reperti.rdf";
	private final String KB_NAMED_MODEL = "find-material";
	private final String INDEX_PATH = "indexes/find-material";
	
	private static FindMaterialLinker instance;
	private IndexSearcher isearcher;
	
	private FindMaterialLinker(){
		super();
		Path indexPath = null;
	...
	public QName getName() {
		return new QName("https://w3id.org/arco/saxon-extension", "mtc-definition");
	}
